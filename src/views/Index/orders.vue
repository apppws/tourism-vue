<template>
  <div>
    ...
    <section class="form-box">
      <div class="form-sub">
        <span>前往省</span>
        <select id="prov" v-model="selectProv" v-on:change="getProv($event)">
          <option v-for="(item,k) in provs" :label="item.label" :value="item.value" :key="k"></option>
        </select>
      </div>
      <div class="form-sub" v-if="selectProv!=''">
        <span>前往市</span>
        <select id="city" v-if="selectProv!=''" v-model="selectCity" v-on:change="getCity($event)">
          <option v-for="(item,k) in citys" :label="item.label" :value="item.value" :key="k"></option>
        </select>
      </div>
      <div class="form-sub">
        <span>同行人数</span>
